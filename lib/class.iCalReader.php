<?php
/**
 * This PHP class will read an ICS (`.ics`, `.ical`, `.ifb`) file, parse it and return an array of its contents.
 *
 * PHP 5 (≥ 5.3.0)
 *
 * @category Parser
...
class ICal
{
     ...
     * @return string
     */
    private function unfold(array $lines)
    {
